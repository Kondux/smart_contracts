 ...
 *     - PARTNER_CUT_BP: Partner cut in basis points (default: 0 = 0%)
 *     - CREATOR_CUT_BP: Default creator cut in basis points (default: 500 = 5%)
...
contract DeployCollectionWithSplitterScript is Script {
    ...
    function _loadConfig() internal view returns (DeployConfig memory cfg) {
        ...
        cfg.manufacturerCutBP = uint96(vm.envOr("MANUFACTURER_CUT_BP", uint256(500)));
        cfg.partnerCutBP = uint96(vm.envOr("PARTNER_CUT_BP", uint256(0)));
        cfg.creatorCutBP = uint96(vm.envOr("CREATOR_CUT_BP", uint256(500)));
