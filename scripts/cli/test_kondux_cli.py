...
# Kondux collection addresses (v2 on mainnet)
KONDUX_COLLECTION = os.environ.get("COLLECTION_ADDRESS", "0x167a45aaC7a4512089eC6d401547351d7c73e66F")
SEAPORT_ADDRESS = "0x0000000000000068F116a894984e2DB1123eB395"
SEAPORT_HELPER_ADDRESS = "0x92bC05d397Fc5d2E18d4d2DAf7EA8f60f7d67a1F"
...
class TestMainnetRoyalty:
    ...
    def mainnet_w3(self):
        ...
        if not rpc_url:
            pytest.skip("MAINNET_RPC_URL environment variable not set")
