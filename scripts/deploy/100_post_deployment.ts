...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
    ...
    await waitFor(authority.pushRole(minterDeployment.address, ethers.utils.keccak256(ethers.utils.toUtf8Bytes("MINTER_ROLE"))));
    console.log("Setup -- authority.setRole: set minter to " + minterDeployment.address);
