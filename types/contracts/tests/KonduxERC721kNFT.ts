...
export interface KonduxERC721kNFTInterface extends utils.Interface {
  functions: {
...
export interface KonduxERC721kNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KonduxERC721kNFTInterface;
